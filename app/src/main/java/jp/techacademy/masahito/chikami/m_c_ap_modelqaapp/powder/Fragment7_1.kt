...
class Fragment7_1 : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment7_1, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        button5.setOnClickListener {
            if (button5.text == "クラリスロマイシンDS10%小児用")
                button5.setText("クラシスロマイシン")
            else {
                button5.setText("クラリスロマイシンDS10%小児用")
            }
        }
        button6.setOnClickListener {
            if (button6.text == "ジピリダモール散12.5%")
                button6.setText("ジピリダモール")
            else {
                button6.setText("ジピリダモール散12.5%")
            }
        }
        ...
        checkbox_blank1.setOnClickListener {
            if (flag1 == true) {
                ...
                flag1 = false
                editor.putBoolean("CHECK7101", flag1)
                editor.commit()
            } else {
        ...
        if (preferences.getBoolean("CHECK7101", true) == false) {
            checkbox_blank1.setImageResource(R.drawable.ic_checkbox_check)
            flag1 = false
        }
        ...
        checkbox_blank2.setOnClickListener {
            if (flag2 == true) {
                ...
                flag2 = false
                editor.putBoolean("CHECK7102", flag2)
                editor.commit()
            } else {
        ...
        if (preferences.getBoolean("CHECK7102", true) == false) {
            checkbox_blank2.setImageResource(R.drawable.ic_checkbox_check)
            flag2 = false
        }
        ...
        checkbox_blank3.setOnClickListener {
            if (flag3 == true) {
                ...
                flag3 = false
                editor.putBoolean("CHECK7103", flag3)
                editor.commit()
        ...
        if (preferences.getBoolean("CHECK7103", true) == false) {
            checkbox_blank3.setImageResource(R.drawable.ic_checkbox_check)
            flag3 = false
        }
        ...
        checkbox_blank4.setOnClickListener {
            if (flag4 == true) {
                ...
                flag4 = false
                editor.putBoolean("CHECK7104", flag4)
                editor.commit()
            } else {
        ...
        if (preferences.getBoolean("CHECK7104", true) == false) {
            checkbox_blank4.setImageResource(R.drawable.ic_checkbox_check)
            flag4 = false
        }
        ...
        checkbox_blank5.setOnClickListener {
            if (flag5 == true) {
                ...
                flag5 = false
                editor.putBoolean("CHECK7105", flag5)
                editor.commit()
            } else {
        ...
        if (preferences.getBoolean("CHECK7105", true) == false) {
            checkbox_blank5.setImageResource(R.drawable.ic_checkbox_check)
            flag5 = false
        }
        ...
        checkbox_blank6.setOnClickListener {
            if (flag6 == true) {
                ...
                flag6 = false
                editor.putBoolean("CHECK7106", flag6)
                editor.commit()
            } else {
        ...
        if (preferences.getBoolean("CHECK7106", true) == false) {
            checkbox_blank6.setImageResource(R.drawable.ic_checkbox_check)
            flag6 = false
        }
        ...
        checkbox_blank7.setOnClickListener {
            if (flag7 == true) {
                ...
                flag7 = false
                editor.putBoolean("CHECK7107", flag7)
                editor.commit()
            } else {
        ...
        if (preferences.getBoolean("CHECK7107", true) == false) {
            checkbox_blank7.setImageResource(R.drawable.ic_checkbox_check)
            flag7 = false
        }
        ...
        checkbox_blank8.setOnClickListener {
            if (flag8 == true) {
                ...
                flag8 = false
                editor.putBoolean("CHECK7108", flag8)
                editor.commit()
            } else {
        ...
        if (preferences.getBoolean("CHECK7108", true) == false) {
            checkbox_blank8.setImageResource(R.drawable.ic_checkbox_check)
            flag8 = false
        }
        ...
        view.findViewById<ImageView>(R.id.button_next).setOnClickListener {
            findNavController().navigate(R.id.action_Fragment7_1_to_Fragment7_2)
        }
